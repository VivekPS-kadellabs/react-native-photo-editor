...
public class PhotoEditorActivity extends AppCompatActivity implements View.OnClickListener, OnPhotoEditorSDKListener {
    ...
    private TextView undoTextView, undoTextTextView, doneDrawingTextView, eraseDrawingTextView, pencilSizeTextView;
    private Slider pencilThicknessSlider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pencilSizeTextView = (TextView) findViewById(R.id.pencil_thickness_tv);
        pencilThicknessSlider = (Slider) findViewById(R.id.pencil_thickness_slider);
        ...
        pencilThicknessSlider.addOnChangeListener(new Slider.OnChangeListener() {
            @Override
            public void onValueChange(@NonNull Slider slider, float value, boolean fromUser) {
                System.out.println("----------------- slider value "+value);
                photoEditorSDK.setBrushSize(value);
            }
        });
    ...
    private void updateBrushDrawingView(boolean brushDrawingMode) {
        ...
        if (brushDrawingMode) {
            ...
            pencilSizeTextView.setVisibility(View.VISIBLE);
            pencilThicknessSlider.setVisibility(View.VISIBLE);
            LinearLayoutManager layoutManager = new LinearLayoutManager(PhotoEditorActivity.this, LinearLayoutManager.HORIZONTAL, false);
            ...
            pencilSizeTextView.setVisibility(View.GONE);
            pencilThicknessSlider.setVisibility(View.GONE);
        }
    }
